...
| `agents/services/llm_config.py` | Add `build_orchestrator_config`, `build_sub_agent_config` |
...
Sub-agents use OpenAI vision for screenshot analysis, same as current agent.
