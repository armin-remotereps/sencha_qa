...
class ControllerTimeoutOrderingTests(SimpleTestCase):
    def test_timeouts_are_ordered_so_a_stuck_find_element_call_cannot_stall_the_task(
        ...
        sub_agent_timeout = settings.SUB_AGENT_TIMEOUT_SECONDS
        ...
        self.assertLess(find_element_timeout, sub_agent_timeout)
        self.assertLess(sub_agent_timeout, soft_time_limit)
